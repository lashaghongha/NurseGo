      ...
      {open && (
        <div style={{
          ...
          <h3 style={{ fontSize: 15, fontWeight: 800, marginBottom: 12, color: '#0f172a' }}>
            Citymed — ექთნის სამომსახურო შეთანხმება
          </h3>

          <p><strong>1. ზოგადი დებულებები</strong></p>
          <p>
            წინამდებარე შეთანხმება იდება Citymed პლატფორმასა (შემდგომ „პლატფორმა") და
          ...
          <p>
            სპეციალისტი ვალდებულია გამოიყენოს Citymed-ის კომუნიკაციის არხები (ჩეთი, ზარი)
          ...
          <p style={{ marginTop: 12, color: '#64748b', fontSize: 12 }}>
            ბოლო განახლება: 2026 წლის ივნისი · Citymed Georgia
          </p>
        </div>
      )}
